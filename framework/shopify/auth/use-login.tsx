...
import { CustomerAccessTokenCreateInput, CustomerUserError, Mutation, MutationCheckoutCreateArgs } from '../schema';
...
export const handler: MutationHook<null, {}, CustomerAccessTokenCreateInput> = {
    ...
    async fetcher({ input: { email, password }, options, fetch }) {
        ...
        const { customerAccessTokenCreate } = await fetch<Mutation, MutationCheckoutCreateArgs>({
            ...options,
            variables: {
