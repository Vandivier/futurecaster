...
export type SwatchOptionFragment = { __typename?: 'SwatchOptionValue' } & Pick<SwatchOptionValue, 'isDefault' | 'hexColors'>;
        ...
        edges?: Maybe<
            Array<
                Maybe<
                    { __typename?: 'ProductOptionValueEdge' } & {
                        node:
                            | ({ __typename?: 'MultipleChoiceOptionValue' } & Pick<MultipleChoiceOptionValue, 'label'>)
                            | ({ __typename?: 'ProductPickListOptionValue' } & Pick<ProductPickListOptionValue, 'label'>)
                            | ({ __typename?: 'SwatchOptionValue' } & Pick<SwatchOptionValue, 'label'> & SwatchOptionFragment);
                    }
                >
            >
        >;
...
export type ProductInfoFragment = { __typename?: 'Product' } & Pick<Product, 'entityId' | 'name' | 'path' | 'description'> & {
                    ...
                    Maybe<
                        { __typename?: 'VariantEdge' } & {
                            node: { __typename?: 'Variant' } & Pick<Variant, 'entityId'> & {
                                    defaultImage?: Maybe<{ __typename?: 'Image' } & Pick<Image, 'urlOriginal' | 'altText' | 'isDefault'>>;
                                };
                        }
                    >
                >
            ...
            edges?: Maybe<
                Array<
                    Maybe<
                        { __typename?: 'ProductOptionEdge' } & {
                            node:
                                | ({ __typename: 'CheckboxOption' } & Pick<CheckboxOption, 'entityId' | 'displayName'>)
                                | ({ __typename: 'DateFieldOption' } & Pick<DateFieldOption, 'entityId' | 'displayName'>)
                                | ({ __typename: 'FileUploadFieldOption' } & Pick<FileUploadFieldOption, 'entityId' | 'displayName'>)
                                | ({ __typename: 'MultiLineTextFieldOption' } & Pick<MultiLineTextFieldOption, 'entityId' | 'displayName'>)
                                | ({ __typename: 'MultipleChoiceOption' } & Pick<MultipleChoiceOption, 'entityId' | 'displayName'> &
                                      MultipleChoiceOptionFragment)
                                | ({ __typename: 'NumberFieldOption' } & Pick<NumberFieldOption, 'entityId' | 'displayName'>)
                                | ({ __typename: 'TextFieldOption' } & Pick<TextFieldOption, 'entityId' | 'displayName'>);
                        }
                    >
                >
            >;
                                  ...
                                  Maybe<
                                      { __typename?: 'VariantEdge' } & {
                                          node: { __typename?: 'Variant' } & Pick<Variant, 'entityId'> & {
                                                  ...
                                                  prices?: Maybe<{ __typename?: 'Prices' } & ProductPricesFragment>;
                                                  inventory?: Maybe<
                                                      { __typename?: 'VariantInventory' } & Pick<VariantInventory, 'isInStock'> & {
                                                              aggregated?: Maybe<
                                                              ...
                                                              Maybe<
                                                                  { __typename?: 'ProductOptionEdge' } & {
                                                                      node:
                                                                          ...
                                                                          | ({
                                                                                __typename: 'MultiLineTextFieldOption';
                                                                            } & Pick<MultiLineTextFieldOption, 'entityId' | 'displayName'>)
                                                                          | ({
                                                                                __typename: 'MultipleChoiceOption';
                    ...
                    Maybe<
                        { __typename?: 'BrandEdge' } & Pick<BrandEdge, 'cursor'> & {
                                node: { __typename?: 'Brand' } & Pick<
                                    Brand,
                                    'entityId' | 'name' | 'pageTitle' | 'metaDesc' | 'metaKeywords' | 'searchKeywords' | 'path'
                                > & {
                                        defaultImage?: Maybe<{ __typename?: 'Image' } & Pick<Image, 'urlOriginal' | 'altText'>>;
                                    };
                            }
                    >
                >
