...
import getLoggedInCustomer, { Customer } from './handlers/get-logged-in-customer';
...
const customersApi: BigcommerceApiHandler<CustomerData, CustomersHandlers> = async (req, res, config, handlers) => {
