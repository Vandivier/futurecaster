...
export type BigcommerceApiHandler<T = any, H extends BigcommerceHandlers = {}, Options extends {} = {}> = (
    req: NextApiRequest,
...
export default function createApiHandler<T = any, H extends BigcommerceHandlers = {}, Options extends {} = {}>(
