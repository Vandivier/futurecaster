...
import createApiHandler, { BigcommerceApiHandler, BigcommerceHandler } from '../utils/create-api-handler';
import { BigcommerceApiError } from '../utils/errors';
import type { Wishlist, WishlistItem } from '../../customer/get-customer-wishlist';
...
export type WishlistHandlers = {
    getWishlist: BigcommerceHandler<Wishlist, { customerToken?: string; includeProducts?: boolean }>;
    addItem: BigcommerceHandler<Wishlist, { customerToken?: string } & Partial<AddItemBody>>;
    removeItem: BigcommerceHandler<Wishlist, { customerToken?: string } & Partial<RemoveItemBody>>;
};

const METHODS = ['GET', 'POST', 'DELETE'];

// TODO: a complete implementation should have schema validation for `req.body`
const wishlistApi: BigcommerceApiHandler<Wishlist, WishlistHandlers> = async (req, res, config, handlers) => {
