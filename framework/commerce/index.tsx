...
export type CommerceConfig = Omit<CommerceContextValue<any>, 'providerRef' | 'fetcherRef'>;
...
export function CommerceProvider<P extends Provider>({ provider, children, config }: CommerceProps<P>) {
    if (!config) {
