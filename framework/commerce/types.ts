...
export type AddCartItemHandlerBody<T extends CartItemBody> = Partial<AddCartItemBody<T>> & {
    cartId?: string;
};
...
export type UpdateCartItemHandlerBody<T extends CartItemBody> = Partial<UpdateCartItemBody<T>> & {
    cartId?: string;
};
