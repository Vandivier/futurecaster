...
export type UseRemoveItem<
    H extends MutationHook<any, any, any> = MutationHook<Cart | null, { item?: LineItem }, RemoveItemInput, RemoveCartItemBody>
> = ReturnType<H['useHook']>;

export const fetcher: HookFetcherFn<Cart | null, RemoveCartItemBody> = mutationFetcher;
