...
export type SwellApiHandler<T = any, H extends SwellHandlers = {}, Options extends {} = {}> = (
    req: NextApiRequest,
...
export default function createApiHandler<T = any, H extends SwellHandlers = {}, Options extends {} = {}>(
